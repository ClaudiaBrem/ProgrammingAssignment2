...
Each person performed six activities (see below) wearing a smartphone (Samsung Galaxy S II) on the waist.
...
Identifiers
    ...
    activity_id - The ID of the activity that was performed
    activity_type - The type of activity performed when the corresponding measurements were taken
		(This identifier is redundant, because activity_id is sufficient. It is more descriptive, though.)
...
Final Dataset: str(final_data)

Summary of final dataset: summary(final_data)
